...
use App\Service\MilvusVectorStoreService; // Added
...
class ProcessImageCommand extends Command
{
    ...
    /**
     * @var MilvusVectorStoreService The service to interact with the vector database.
     */
     ...
     * @param MilvusVectorStoreService $milvusVectorStoreService The service to interact with the vector database.
     */
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            try {
                // Assuming MilvusVectorStoreService::searchSimilarProducts returns an array of objects
                // each with getId(), getName(), and getScore() methods.
                $similarProducts = $this->milvusVectorStoreService->searchSimilarProducts($embedding, 5);
            } catch (\Exception $e) {
